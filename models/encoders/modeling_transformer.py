...
from models.encoders.vit_utils import to_2tuple, prune_linear_layer, find_pruneable_heads_and_indices
...
class TransformerModel(nn.Module):
    def __init__(self, config: ViTConfig):
        ...
        self.embeddings = nn.Linear(config.num_channels, config.hidden_size)
